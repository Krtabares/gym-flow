  ...
  private initializeMockData() {
    ...
    if (!localStorage.getItem('gf_ejercicios')) {
      const mockEjercicios: Ejercicio[] = [
        ...
        { id: 'e90', nombre: 'Baby Maker', categoria: 'Estiramiento', descripcion: 'Estiramiento y ejercicio de movilidad en cuclillas profundas abriendo las rodillas con los codos y sosteniendo los pies.', equipamiento: 'Ninguno' },
        { id: 'e91', nombre: 'Monster Walk', categoria: 'Calentamiento', descripcion: 'Caminar lateralmente o hacia adelante con una banda de resistencia alrededor de los tobillos o rodillas manteniendo una media sentadilla.', equipamiento: 'Banda elástica (Band)' },
